...
async def async_main(args=None):
    ...
    try:
        ...
        async with Client(
            ...
            #NodeIds einlesen
            execute_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x8Y4cYr2NHHp")
            error_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x8YyZobxH1eG5yUU")
            JointGoal_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x8kvfYf3H1OG4iwU")
            MotionType_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x84vYIDsLku9+jBx6Q==")
            PlannerID_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x9MsdYftJWa2ygQU")
            TCPGoal_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x9cDRLbED1Wlgw==")
            accelerationscaling_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x+4hbLbiI3eM7yVmiPcpe4fcM3eI7yl6joM=")
            axis_0_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x+I4fZrccBQ=")
            axis_1_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x+I4fZrccRQ=")
            axis_2_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x+I4fZrcchQ=")
            axis_3_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x+I4fZrccxQ=")
            axis_4_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x+I4fZrcdBQ=")
            axis_5_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x+I4fZrcdRQ=")
            orientationtolerance_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x+wyfYztNHWd6i96tvcveIzxIXqK5kA=")
            planningattempts_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x+01ebbzLHWH7Sl6jtwhYJ3mLWSd8EA=")
            planningtime_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x+IseIb0JXC28yx1h+0peo7cNH2E5kA=")
            positiontolerance_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x/MvZ4D3KXuH3DR7heYydYfgJRQ=")
            rot_x_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x/EvYLb7QA==")
            rot_y_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x/EvYLb6QA==")
            rot_z_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x/EvYLb5QA==")
            rot_w_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x/EvYLb0QA==")
            trans_x_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x/cydYfwH2zp")
            trans_y_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x/cydYfwH23p")
            trans_z_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x/cydYfwH27p")
            velocityscaling_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x+4hbLb1JXiG4ClgkNwzd4jvKXqOgw==")

            # # Watchdog Variable erhöhren
            watchdog_node = client.get_node("ns=5;s=AQAAAKbhKnGK9zM6uvotdobvJ2ac8zBxx9Evdob3AXed6i96x/QhYIrrJHuO3CN7nO00cZuD")
            watchdog_counter = 0
